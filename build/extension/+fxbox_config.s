...
PI_AdMouse	dc.l 0			* 4 - Adresse souris
		dc.w 8			* 8 - Nombre de bobs
		dc.w 50			* 10- Position par defaut ecran!!
		dc.l 4*1024		* 12- Taille liste copper
		dc.l 16		* 16- Nombre lignes sprites
; Taille des buffers 
; ~~~~~~~~~~~~~~~~~~
PI_VNmMax	dc.l 1024*6	 * 20- Buffer des noms de variable
PI_TVDirect	dc.w 42*6		* 24- Variables mode direct
PI_DefSize	dc.l 1024*1		 * 26- Taille buffer par defaut
; Directory
; ~~~~~~~~~
